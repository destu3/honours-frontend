...
import { Container, Card, CardContent, Typography, Button, Chip, Box, useTheme, Avatar, Stack } from '@mui/material';
...
export default function Transactions() {
  ...
  const handleGenerate = async () => {
    const { newTransactions, deductedAmount } = await generateTransactions(accountId);
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                  ...
                  <Box>
                    ...
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Chip label={label} color={color as 'primary' | 'secondary' | 'success'} variant="outlined" size="small" />
